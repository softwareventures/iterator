...
test("keyLastByOnce", t => {
    const map = keyLastByOnce(iterator([1, 3, 4, 2, 5, 6]), e => (e % 2 === 0 ? "even" : "odd"));
    t.deepEqual(Array.from(map.entries()), [
        ["odd", 5],
        ["even", 6]
    ]);
...
test("mapKeyByOnce", t => {
    const map = mapKeyByOnce(iterator([1, 3, 4, 2, 5, 6]), e => [
        e % 2 === 0 ? "even" : "odd",
        String(e)
    ]);
...
test("mapKeyFirstByOnce", t => {
    const map = mapKeyFirstByOnce(iterator([1, 3, 4, 2, 5, 6]), e => [
        e % 2 === 0 ? "even" : "odd",
        String(e)
    ]);
    t.is(map.get("even"), "4");
